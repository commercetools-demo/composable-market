...
import McApp from './routes/mc-app';
import McView from './routes/mc-view';
import ConnectApp from './routes/connect-app';
...
const ApplicationRoutes = (_props: ApplicationRoutesProps) => {
  ...
  return (
    <Spacings.Inset scale="l">
      <Switch>
        <Route path={`${match.path}/mc-app/:region/:id`}>
          <McApp />
        </Route>
        <Route path={`${match.path}/connect-app/:region/:id`}>
          <ConnectApp />
        </Route>
        <Route path={`${match.path}/mc-view/:region/:id`}>
          <McView />
        </Route>
        <Route>
          <Welcome />
